<meta charset="utf-8">
<title>VueX-Laravel-ADMIN</title>
...
<link rel="stylesheet" href="{{ url('vendor/adminlte/css/custom.css') }}">
<link rel="stylesheet" href="{{ url('vendor/adminlte/css/skins/skin-red.min.css') }}">
