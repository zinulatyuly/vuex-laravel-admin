...
export default {
  data() {
    return {
      ...
      xprops: {
        module: 'FormDepartmentsIndex',
        route: 'form-departments',
      },
    };
  },
  created() {
  ...
  computed: {
    ...mapGetters('FormDepartmentsIndex', ['data', 'total', 'loading', 'relationships']),
  },
  watch: {
    query: {
      handler(query) {
  ...
  methods: {
    ...mapActions('FormDepartmentsIndex', ['fetchData', 'setQuery', 'resetState']),
  },
};
</script>
